define(['jquery', 'backbone', 'handlebars', 'lu-model-state'], function ($, Backbone, Handlebars, appState) {
    ...
    return Backbone.View.extend({
        ...
        initialize: function () {
            ...
            this.listenTo(appState, 'change:packageDocument', function (appState, packageDocument) {
        ...
        onItemClick: function (e) {
            ...
            if (!appState.get('readium').reader.openContentUrl($(e.target).attr('data-dst'))) {
                appState.get('readium').reader.openContentUrl('xhtml/' + $(e.target).attr('data-dst'));
            }
        }
    });
});
